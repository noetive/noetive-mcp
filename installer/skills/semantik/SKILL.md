---
name: semantik
description: Explain what Noetive Semantik is and which capability fits a problem. Use when the user mentions Semantik, a semantic broker or semantic pub/sub, asks how it differs from a message broker or a vector database, asks whether to search or subscribe, or describes wanting agents to share what they learn and find it by meaning. Covers namespaces, messages, subscriptions and how a call is routed.
---
